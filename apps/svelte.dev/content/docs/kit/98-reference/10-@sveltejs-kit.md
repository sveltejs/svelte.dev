...
See [matching](/docs/kit/advanced-routing#Matching) for more info.

<div class="ts-block">

```dts
interface ParamMatcherModule {/*…*/}
```
...
The shape of a param parser. See [matching](/docs/kit/advanced-routing#Matching) for more info.

<div class="ts-block">

```dts
type ParamParser<T = any> = (param: string) => T;
```
