...
- <span class="tag since">available since</span> v2.5.0
- <span class="tag deprecated">deprecated</span> Removed in 3.0.0. Add a Vite plugin that configures the dev and preview server instead
