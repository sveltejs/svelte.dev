...
Use `$effect` instead — see /docs/svelte/$effect
...
Use `$effect.pre` instead — see /docs/svelte/$effect#$effect.pre
...
Use callback props and/or the `$host()` rune instead — see /docs/svelte/v5-migration-guide#Event-changes-Component-events
