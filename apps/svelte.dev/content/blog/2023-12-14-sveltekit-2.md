...
The [migration guide](https://svelte.dev/docs/kit/migrating-to-sveltekit-2) has more details about what's new.
...
That feature is called [shallow routing](https://svelte.dev/docs/kit/shallow-routing), and this week we finally dusted off the pull request and added it to the framework. We're excited to see what you use it for.
