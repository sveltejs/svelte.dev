...
To get started, run `npm create svelte@latest`, and visit the [docs](https://svelte.dev/docs/kit) and (experimental!) [interactive tutorial](https://learn.svelte.dev).
...
This is made possible by [adapters](https://svelte.dev/docs/kit/adapters). The default adapter, [adapter-auto](https://github.com/sveltejs/kit/tree/master/packages/adapter-auto), provides zero-config support for Vercel, Netlify, Cloudflare Pages and Azure Static Web Apps, with more platforms coming in the future. Community-provided adapters add support for Deno, Bun, Firebase, App Engine, AWS Lambda and many others.
