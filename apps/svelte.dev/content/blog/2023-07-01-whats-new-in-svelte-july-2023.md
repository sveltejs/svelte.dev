...
- The new `event.isSubRequest` boolean indicates whether this is a same-origin fetch request to one of the app's own APIs during a server request (**1.21.0**, [Docs](/docs/kit/$app-server$#RequestEvent), [#10170](https://github.com/sveltejs/kit/pull/10170))
