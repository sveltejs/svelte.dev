...
- `$env/static/public` is now exposed in service workers (**2.2.0**, [Docs](/docs/kit/modules#env-static-public), [#10994](https://github.com/sveltejs/kit/pull/10994))
...
- The `read` function is now available in the `$app/server` module - allowing you to read assets from the filesystem (**2.4.0**, [Docs](/docs/kit/modules#app-server-read), [#11649](https://github.com/sveltejs/kit/pull/11649))
