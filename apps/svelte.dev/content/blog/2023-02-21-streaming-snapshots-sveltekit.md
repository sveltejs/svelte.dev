...
Configs are merged at the top level, so you can override values set in a layout for pages further down the tree. For more details, see [the documentation](https://svelte.dev/docs/kit/page-options#config).
...
- The [OPTIONS method](https://svelte.dev/docs/kit/routing#server) is now supported in `+server.js` files
...
- You can now [access public environment variables in app.html](https://svelte.dev/docs/kit/project-structure#project-files-src)
- A new [text helper](https://svelte.dev/docs/kit/modules#sveltejs-kit-text) for creating responses
