...
- Named layouts have been removed in favor of `(groups)` (**1.0.0-next.432**, [Docs](https://svelte.dev/docs/kit/advanced-routing#advanced-layouts), [PR & Migration Instructions](https://github.com/sveltejs/kit/pull/6174))
