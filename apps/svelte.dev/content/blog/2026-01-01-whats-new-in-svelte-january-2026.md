...
- The Svelte CLI is now able to fully setup cloudflare adapter for workers/pages (**sv@0.11.0**, [Docs](https://svelte.dev/docs/cli/sveltekit-adapter#Options-cloudflare-target), [#851](https://github.com/sveltejs/cli/pull/851))
- The Svelte MCP now exposes tool as both a JS API and CLI (**mcp@0.1.16**, [#128](https://github.com/sveltejs/mcp/pull/128))
