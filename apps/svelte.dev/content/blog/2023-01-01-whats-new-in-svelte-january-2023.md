...
- `vitePreprocess` is now the default preprocessor. Please see [the docs](https://svelte.dev/docs/kit/integrations#preprocessors) for differences between `vitePreprocess` and `svelte-preprocess` ([#8036](https://github.com/sveltejs/kit/pull/8036)).
...
- A new `embedded` option, turned off by default, helps with link clicks when embedding SvelteKit ([docs](https://svelte.dev/docs/kit/configuration), [#7969](https://github.com/sveltejs/kit/pull/7969))
