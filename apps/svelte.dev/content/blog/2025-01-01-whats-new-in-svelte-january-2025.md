...
- The new [`transport`](https://svelte.dev/docs/kit/@sveltejs-kit-hooks#Transport) hook allows you to encode/serialize and decode/deserialize custom non-POJOs across the server/client boundary (**2.11.0**, [#13149](https://github.com/sveltejs/kit/pull/13149))
