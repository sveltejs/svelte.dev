...
- `URL` is now accepted in the `redirect` function (**1.23.0**, [Docs](https://svelte.dev/docs/kit/modules#sveltejs-kit-redirect), [#10570](https://github.com/sveltejs/kit/pull/10570))
- Mistyped route filenames will now throw a warning (**1.23.0**, [#10558](https://github.com/sveltejs/kit/pull/10558))
- The new `onNavigate` lifecycle function enables view transitions - Check out the [blog post](https://svelte.dev/blog/view-transitions) for more info (**1.24.0**, [Docs](https://svelte.dev/docs/kit/modules#app-navigation-onnavigate), [#9605](https://github.com/sveltejs/kit/pull/9605))
