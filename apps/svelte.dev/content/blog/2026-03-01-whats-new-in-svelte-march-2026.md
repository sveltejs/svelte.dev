...
- Breaking (Netlify Adapter): `platform.context` now uses modern Netlify Functions - previously this was the AWS Lambda-style
  context. If you were using this in your app (unlikely), you will need to update your code to read from new fields. (**adapter-netlify@6.0.0**, [More details](https://docs.netlify.com/build/functions/api/#netlify-specific-context-object), [Docs](https://developers.netlify.com/guides/migrating-to-the-modern-netlify-functions/), [#15203](https://github.com/sveltejs/kit/pull/15203))
...
- [HelixNotes](https://helixnotes.com/) is a local markdown note-taking app where notes are stored as standard Markdown files on your local filesystem
...
- [Shimmer From Structure](https://shimmer-from-structure-docs.vercel.app/) is a structure-aware skeleton loader that mirrors your rendered UI at runtime
- [Hoikka](https://www.hoikka.dev/) is an opinionated, full-stack e-commerce platform built with SvelteKit
...
- [svelte-crumbs](https://svelte-crumbs.vercel.app/) provides automatic, SSR-ready breadcrumbs for SvelteKit via route-level metadata exports
...
- [svelte-tiler](https://x0k.dev/svelte-tiler/) is a small, unstyled library for building tiling user interfaces
- [@horuse/svelte-dnd](https://svelte-dnd.vercel.app/) is a drag-and-drop library for Svelte 5 with animated drop previews, auto-scroll, pointer & touch support , and multi-container support.
