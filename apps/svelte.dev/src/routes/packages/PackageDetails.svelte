...
<p class="stats">
	{#if pkg.downloads}
		<span title="{pkg.downloads} downloads">
			...
			{format_number(+pkg.downloads)} (<a href="https://www.npmcharts.com/compare/{pkg.name}">+99% YoY</a>)
		</span>
	{/if}
	...
	{#if pkg.github_stars}
		<span title="{pkg.github_stars} Github Stars">
			...
			{format_number(pkg.github_stars)} (<a href="https://www.star-history.com/#{pkg.repo_url.substring('https://github.com/'.length)}&Date">+99% YoY</a>)
		</span>
	{/if}
...
Svelte 5 rune syntax: adopted / legacy<br />
Publint errors: 0
</p>

<h2>Package Weight</h2>
<p><a href="https://npmgraph.js.org/?q={encoded_pkg}" title="999 transitive dependencies">999 dependencies</a></p>
<p>{format_bytes(pkg.dependency_tree.packages.reduce((acc, pkg) => acc + (pkg.size ?? 0), 0))} in server's node_modules</p>
<p>
	<a href="https://bundlejs.com/?q={encoded_pkg}"><img src="https://deno.bundlejs.com/?q={encoded_pkg}&badge=minified&badge-style=for-the-badge"></a>
	<a href="https://bundlejs.com/?q={encoded_pkg}"><img src="https://deno.bundlejs.com/?q={encoded_pkg}&badge&badge-style=for-the-badge"></a>
</p>
